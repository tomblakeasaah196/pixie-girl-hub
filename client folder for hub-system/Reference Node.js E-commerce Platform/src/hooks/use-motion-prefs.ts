...
/**
 * Unified motion preferences. `motion` is false when the user prefers reduced motion
 * OR when running on a low-end device — in that case use simple opacity fades only.
 */
