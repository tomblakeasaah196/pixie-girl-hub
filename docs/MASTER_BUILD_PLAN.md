...
| **F-1**  | Wig subscriptions + maintenance add-on (§6.23.5)                                      | Dimension 3                              | 🟡 management DONE 2026-06-11 — plan CRUD + enrol/pause/resume/cancel (`/retention/subscriptions`). REMAINING: recurring billing cron (Paystack charge_authorization → order) — money-moving, needs staging validation; maintenance add-on                                                   |
| **F-2**  | Bundle offers / package deals (§6.23.4)                                               | Dimension 3                              | 🟡 DONE 2026-06-11 — admin CRUD + components + priceBundle (fixed/pct/amount) over bundle_offers (`/retention/bundles`); buy_x_get_y/tiered_qty params returned for checkout line-logic                                                                                                      |
| **F-3**  | Coupon-code engine (§6.23.2)                                                          | Dimension 3                              | ✅ DONE 2026-06-11 — admin CRUD + row-locked idempotent validate/redeem over shared.coupons (`/retention/coupons`); checkout apply is the remaining integration step                                                                                                                         |
