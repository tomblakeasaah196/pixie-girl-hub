              ...
              <div className="aspect-[4/5] -mx-4 -mt-4 mb-3 overflow-hidden rounded-t-[var(--radius)] bg-text-primary/[0.04] relative group">
                ...
                {canEdit && (
                  <button
                    ...
                    className="absolute top-2 right-2 inline-flex items-center gap-1 px-2.5 h-8 md:h-7 rounded-[8px] text-[11px] font-semibold dropglass text-text-primary opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity"
                  >
    ...
    >
      <div className="space-y-4">
        {campaignFeedback && (
          <div
            className={cn(
              "rounded-[10px] px-3 py-2 text-[12px] font-medium",
