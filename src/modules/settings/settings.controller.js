...
const setDefaultTemplate = async (req, res) =>
  res.json({
    data: await service.setDefaultTemplate({ ...base(req), id: req.params.id }),
  });
const deleteTemplate = async (req, res) =>
  res.json({
    data: await service.deleteTemplate({ ...base(req), id: req.params.id }),
  });
...
const upsertNotificationPref = async (req, res) =>
  res.json({
    data: await service.upsertNotificationPref({
      user: req.user,
      request_id: req.request_id,
      input: req.body,
    }),
...
const createReport = async (req, res) =>
  res
    .status(201)
    .json({
      data: await service.createReport({ ...base(req), input: req.body }),
    });
const updateReport = async (req, res) =>
  res.json({
    data: await service.updateReport({
      ...base(req),
      id: req.params.id,
      input: req.body,
    }),
...
const deleteReport = async (req, res) =>
  res.json({
    data: await service.deleteReport({ ...base(req), id: req.params.id }),
  });
...
const setSecret = async (req, res) =>
  res
    .status(201)
    .json({ data: await service.setSecret({ ...base(req), input: req.body }) });
const deleteSecret = async (req, res) =>
  res.json({
    data: await service.deleteSecret({ ...base(req), id: req.params.id }),
  });
...
const createPolicy = async (req, res) =>
  res
    .status(201)
    .json({
      data: await service.createPolicy({ ...base(req), input: req.body }),
    });
const updatePolicy = async (req, res) =>
  res.json({
    data: await service.updatePolicy({
      ...base(req),
      id: req.params.id,
      input: req.body,
    }),
...
const deletePolicy = async (req, res) =>
  res.json({
    data: await service.deletePolicy({ ...base(req), id: req.params.id }),
  });
