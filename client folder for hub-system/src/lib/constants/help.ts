...
export const AREA_MODULE_KEYS = new Set(HELP_AREAS.flatMap((a) => a.modules));
...
export const COMMON_TASKS: CommonTask[] = [
  {
    label: "Create an invoice or bill a customer",
    module: "invoicing",
    icon: FileText,
  },
  ...
  {
    label: "Message a teammate or customer",
    module: "messaging",
    icon: MessageCircle,
  },
...
export const GLOSSARY: GlossaryTerm[] = [
  {
    term: "Adjustment",
    definition:
      "A correction to a stock count after you physically count items and find the system number is wrong.",
  },
  {
    term: "Audit log",
    definition:
      "An automatic diary of every action taken in the system — who did what, and when. Handy for checking history.",
  },
  {
    term: "Catalogue",
    definition:
      "Your master list of products. Everything you sell or track starts as a product here.",
  },
  {
    term: "Chart of accounts",
    definition:
      "The list of 'buckets' your money is sorted into for bookkeeping — like assets, income, and expenses.",
  },
  {
    term: "Consignment",
    definition:
      "Stock you place with another shop to sell on your behalf. You only get paid once it sells.",
  },
  {
    term: "Credit note",
    definition:
      "A document that cancels or reduces an invoice — used when you refund a customer or correct an over-charge.",
  },
  {
    term: "Deal",
    definition:
      "A potential sale you're tracking in CRM as it moves from first enquiry toward 'won' or 'lost'.",
  },
  {
    term: "Fiscal period",
    definition:
      "A chunk of time (usually a month) for your accounts. 'Closing' it locks the books so figures can't change.",
  },
  {
    term: "GRN",
    definition:
      "Goods Received Note — the record of what actually arrived from a supplier, checked against your order.",
  },
  {
    term: "Invoice",
    definition:
      "A bill you send a customer asking them to pay for goods or services.",
  },
  {
    term: "Journal entry",
    definition:
      "The behind-the-scenes bookkeeping record of money moving. The system usually creates these for you automatically.",
  },
  {
    term: "Lead",
    definition:
      "Someone who has shown interest but hasn't bought yet — the start of a deal in CRM.",
  },
  {
    term: "Loyalty tier",
    definition:
      "A level (like Bronze, Silver, Gold) a customer reaches by earning points. Higher tiers can unlock perks.",
  },
  {
    term: "PAYE",
    definition:
      "Pay As You Earn — the income tax deducted from staff salaries and paid to the tax authority on their behalf.",
  },
  {
    term: "Payslip",
    definition:
      "A statement showing a staff member's pay for the month — earnings, deductions, and the final amount.",
  },
  {
    term: "Pipeline",
    definition:
      "The visual board in CRM showing your deals lined up by stage, from new enquiry to closed.",
  },
  {
    term: "POS session",
    definition:
      "A shift at the till. You 'open' it to start selling and 'close' it to count the cash at the end.",
  },
  {
    term: "Purchase order (PO)",
    definition:
      "An official order you send a supplier listing what you want to buy and at what price.",
  },
  {
    term: "Quotation",
    definition:
      "A price offer you send a customer before they commit. Once accepted, it becomes a sales order.",
  },
  {
    term: "Reconciliation",
    definition:
      "Matching your bank statement against the payments recorded in the system to make sure they agree.",
  },
  {
    term: "RFQ",
    definition:
      "Request For Quotation — asking several suppliers for their prices so you can compare before buying.",
  },
  {
    term: "Role",
    definition:
      "A set of permissions (like 'Manager' or 'Sales') that decides which parts of the system a person can use.",
  },
  {
    term: "Sales order",
    definition:
      "A confirmed order from a customer, created once they accept your quotation.",
  },
  {
    term: "Settlement",
    definition:
      "Squaring up money owed with a retail partner after their consignment sales — what you owe them, or they owe you.",
  },
  {
    term: "SKU",
    definition:
      "A unique code for a specific product or variant, used to track it precisely in stock.",
  },
  {
    term: "Transfer",
    definition:
      "Moving stock from one location to another. One person sends it; another confirms it arrived.",
  },
  {
    term: "VAT",
    definition:
      "Value Added Tax — a tax added to most sales that you collect from customers and pass on to the government.",
  },
  {
    term: "WHT",
    definition:
      "Withholding Tax — a slice of certain payments held back and remitted to the tax authority on the recipient's behalf.",
  },
];
