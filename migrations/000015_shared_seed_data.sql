...
INSERT INTO shared.ai_feature_flags (feature_key, display_name, description, is_enabled, default_provider, default_model, est_cost_per_call_ngn) VALUES
  ...
  ('products_ai_drafting',         'Products — AI Drafting',        'Drafts a Styled product (name, copy, SEO, category/collection suggestions) over a base for human review. Only ever creates a DRAFT — never publishes.', true, 'deepseek', 'deepseek-chat', 0.40),
