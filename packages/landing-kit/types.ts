...
// The contract + helpers live alongside this file in @landing-kit so the
// public page renders identically to the studio preview. Re-exported here so
// consumers of "@landing-kit/types" (and the apps/landing "@/lib/types" shim)
...
export { hexToTriplet, withDefaults, defaultConfig } from "./config";
