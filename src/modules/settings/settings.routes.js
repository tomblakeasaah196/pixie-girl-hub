...
router.post("/document-templates", can("create"), validator.validateTemplateCreate, controller.createTemplate);
router.patch("/document-templates/:id", can("edit"), validator.validateTemplateUpdate, controller.updateTemplate);
router.post("/document-templates/:id/set-default", can("edit"), controller.setDefaultTemplate);
router.delete("/document-templates/:id", can("delete"), controller.deleteTemplate);
...
router.put("/notification-preferences", validator.validateNotificationPref, controller.upsertNotificationPref);

// ── scheduled_reports ────────────────────────────────────
router.get("/scheduled-reports", can("view"), controller.listReports);
router.post("/scheduled-reports", can("create"), validator.validateReportCreate, controller.createReport);
router.patch("/scheduled-reports/:id", can("edit"), validator.validateReportUpdate, controller.updateReport);
