...
export type ModuleGroup = "run" | "operate" | "finance" | "people" | "grow" | "system";
...
export const GROUP_ORDER: ModuleGroup[] = ["run", "operate", "finance", "people", "grow", "system"];

/** The full module catalogue. Routes mount under the AppShell. */
export const MODULES: AppModule[] = [
  { key: "dashboard", label: "Dashboard", description: "KPIs & today", group: "run", route: "/dashboard", icon: LayoutDashboard },
  { key: "sales", label: "Sales", description: "Orders, quotes, payments", group: "run", route: "/sales", icon: ShoppingBag, badgeKey: "sales" },
  ...
  { key: "purchasing", label: "Purchasing", description: "Imports & POs", group: "operate", route: "/purchasing", icon: ShoppingCart },
  { key: "production", label: "Production", description: "Landed cost & jobs", group: "operate", route: "/production", icon: Factory },
  { key: "retail", label: "Retail Partners", description: "Consignment", group: "operate", route: "/retail-partners", icon: Store },
  { key: "stylists", label: "Stylists", description: "Partner programme", group: "operate", route: "/stylists", icon: Scissors },
  { key: "invoicing", label: "Invoicing", description: "Billing & live AR", group: "finance", route: "/invoicing", icon: FileText, badgeKey: "invoicing" },
  { key: "accounting", label: "Accounting", description: "The books", group: "finance", route: "/accounting", icon: BookOpen },
  { key: "expenses", label: "Expenses", description: "Claims & advances", group: "finance", route: "/expenses", icon: Receipt },
  { key: "pricing", label: "Pricing", description: "Margin & fees", group: "finance", route: "/pricing", icon: Tag },
  { key: "cash", label: "Cash Requests", description: "Disbursements", group: "finance", route: "/cash-requests", icon: Wallet, badgeKey: "cash" },
  { key: "intercompany", label: "Intercompany", description: "Cross-brand settlement", group: "finance", route: "/intercompany", icon: ArrowLeftRight },
  { key: "hr", label: "HR & Payroll", description: "People & pay", group: "people", route: "/hr", icon: UserCog },
  { key: "contacts", label: "Contacts", description: "Directory", group: "people", route: "/contacts", icon: Contact },
  ...
  { key: "storefront_studio", label: "Storefront Studio", description: "Templates & vocabulary", group: "system", route: "/storefront-studio", icon: Palette },
  { key: "notifications", label: "Notifications", description: "Feed & alerts", group: "system", route: "/notifications", icon: Bell },
